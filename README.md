...
| attach an external advisor surface (GPT or Claude in chat form) to an existing repo | [`templates/advisor-project-bootstrap.template.md`](templates/advisor-project-bootstrap.template.md) + [`templates/advisor-project-instructions.template.md`](templates/advisor-project-instructions.template.md) |
...
- Optionally generate a surface bootstrap from [`templates/advisor-project-bootstrap.template.md`](templates/advisor-project-bootstrap.template.md) and install the thin floor from [`templates/advisor-project-instructions.template.md`](templates/advisor-project-instructions.template.md) into the advisor Project Instructions.
