...
**Route on approval.** Once ASK has approved a recipient copy, route it immediately unless routing is explicitly held. Routing is not feeding: placing the copy in the recipient intake makes the material durably available, and that placement neither obliges nor constitutes handing it to an active surface. Holding an approved copy unrouted makes the queue lie in the other direction — material that should be visible as available is invisible instead.
