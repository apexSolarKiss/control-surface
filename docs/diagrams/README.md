...
The current tuple is `source-v6 // render-v18` (2026-07-25). Source advances when the authored architecture changes; render advances only when the renderer realization changes.
