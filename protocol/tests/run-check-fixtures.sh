...
d=$(owner_copy L3t); for f in protocol/AGENTS.shared.md AGENTS.md; do perl -0pi -e 's/\*\*Route on approval\.\*\*//g' "$d/$f"; done; record "NEG carriers lose the route-on-approval clause" 1 "four-event lifecycle clause(s) missing or stale" runlocal "$d"
